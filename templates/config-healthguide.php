...
<body>
        ...
        <div class="container">
            <div class="card">
                ...
                <form>
                    ...
                    <button type="button" onclick="alert('Configuração guardada (demo)')">
                        Guardar
                    </button>
                </form>
    ...
    <div class="footer">
        © 2025 HealthGuide — Singleton · Facade · Observer<br>
        Pedro Pereira - 1102837<br>
        Universidade Aberta — Arquitetura e Padrões de Software
    </div>
